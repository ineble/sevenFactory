   ...
   <div class="header-wrap">
         <div class="center-tab">
          <a href="hotelInfo" >AboutUs</a>
            <a href="hotelListPage" >HotelInfo</a>
          <a href="reservation">Reservation</a>
           <a href="main"><img id="logo" alt="logo" src="resources/logo/logogo.png"/></a>
          <div class="dropdown">
                 <a >Board▼</a>
         ...
         <div id="login" class="login-box">
            <form method="POST">
                     <h1 >LOGIN</h1><br/>
                      ...
                      <a href="https://kauth.kakao.com/oauth/authorize?client_id=2ea2f188e336c19e4a984ea7365e2507&redirect_uri=http://localhost:8080/hotelfive/login5&response_type=code">카카오로그인</a>
