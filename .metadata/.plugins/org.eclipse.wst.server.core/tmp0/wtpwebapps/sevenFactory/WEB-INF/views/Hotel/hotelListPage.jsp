...
<style>
	...
	#pagetitle {font-size: 85px; color: white;}
	#hotelfive, #explain {font-weight: bold; color: white;}
...
<jsp:include page="/WEB-INF/views/template/header.jsp">
	...
	<div class="roomListBox">		
		...
		<c:forEach var="hDTO" items="${list2 }" varStatus="k">
			<c:if test="${1 eq (hDTO.hNo % 2)}">
				<div class="roomListOne">
					...
					<a href="roomViewPage?gNo=${gDTO.gNo }&gName=${gDTO.gName}">
					<img usemap="#${k.index }"  alt="${hDTO.hName }" src="resources/assets/hotel_img/${hDTO.hThumbnail }.png">
					<map name="${k.index }">			
						<area class="area1" href="#" shape="rect" coords="16, 276, 150, 318">
					</map>
					</a>
