...
.cal_top #rCheckIn, .cal_top #rCheckOut {
   border: none;
   border-bottom: 1px solid black;
}

.cal_top #rCheckIn:focus, .cal_top #rCheckOut:focus {
   outline: none;
}

.cal_top input[type=button] {
   width: 80px;
   border: none;
...
.cal_top input[type=button]:hover, .cal_top input[type=button]:focus {
...
#cal_tab_info table td:first-of-type {
   font-weight: bold;
   vertical-align: top;
}

#cal_tab_info table td {
   padding: 5px;
}

#cal_tab_info tr:nth-of-type(3) td {
   padding-bottom: 151px;
}

#cal_tab_info tr td:nth-of-type(2) {
   text-align: left;
}
...
#select_info table td {
   border-bottom: 1px solid silver;
   padding-bottom: 5px;
}

#select_info table td:nth-of-type(1) {
   text-align: center;
   width: 10%;
}

#select_info table td:nth-of-type(2) {
   text-align: left;
   width: 150px;
}

#select_info table td:nth-of-type(3) {
   text-align: left;
   width: 20%;
}

#select_info table td:nth-of-type(4) {
   text-align: right;
}

#select_info table tr:last-of-type td {
   border-bottom: none;
}
...
.reservationBtn:hover, .sel .reservationBtn:focus {
   background-color: #353535;
   outline: none;
}
...
.bookableList_backimg {
   ...
   background-image:
      url("resources/assets/background_img/bookableListback.png");
   text-align: center;
   color: white;
   padding-top: 300px;
}
...
<script>
	localstorage.setItem("che",${rCheckIn});
</script>
...
<div class="cal_top">
   ...
   <form>
      <input type="text" name="rCheckIn" id="rCheckIn" readonly placeholder="체크인" /> 
         ...
         <input type="button" value="검색" onclick="fn_go(this.form)" /> <input type="button"
...
<div id="info">
   ...
   <div style="text-aㅓ네lign: left; padding-top: 50px;">
      <h4>
         ...
         <table>
            ...
            <c:if test="${not empty list }">
               <c:forEach var="hDTO" items="${list }" >
                  <tr>
                     <td><a href="roomViewPage?hNo=${hDTO.hNo}&rCheckIn=${rCheckIn}&rCheckOut=${rCheckOut}">
                           <img id="reservation_room" alt="${hDTO.hName }"
                           src="resources/assets/hotel_img/${hDTO.hThumbnail }.png">
                     </a></td>
                     <td>${hDTO.hName } <br /> 주소 : ${hDTO.hAddress}</td>
                     <td>최저가: ${hDTO.hMinprice}</td>
