...
public class KakaoCommand {
	...
	public void execute1(String name, String email, String id, String birtyday, SqlSession sqlSession, Model model) {
		...
		mDTO.setmPw("123");
		mDTO.setmName(name);
		mDTO.setmBirth(birtyday);
		mDTO.setmPhone("00000000000");
		mDTO.setmEmail(email);
		System.out.println(email);
		mDTO.setmAddr1("대전서구");
		mDTO.setmAddr2("인스빌리베라");
