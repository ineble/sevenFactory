...
//**********************************************************************************************************************************************************************
   ...
   public ArrayList<Integer> selectBookablehNo(String rCheckOut, String rCheckIn);

   public ArrayList<GuestRoomDTO> ableBooakblegNo(String hno);

   public ArrayList<Integer> selectBookablegNo(int hNo);

   public Collection<? extends Integer> ableBooakblegNo(int hNo);

   public ArrayList<HotelDTO> selectAllhNO();

   public ArrayList<GuestRoomDTO> selectAllgNO();

   public Double getguestRoomRating(GuestRoomDTO gName);

   public Integer getguestRoomRatingvote(GuestRoomDTO gName);
