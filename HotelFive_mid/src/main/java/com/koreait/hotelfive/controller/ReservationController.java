...
import com.koreait.hotelfive.command.getrankCommand;
...
public class ReservationController {
	...
	public String selectA(HttpServletRequest request, Model model) {
		//지금 request에 있는 정보 체크인 날짜와 체크아웃 날짜
	...
	@RequestMapping("romrser")
	public String gogogo(HttpServletRequest request,Model model) {
		model.addAttribute("request",request);
		command = new ReservationPageCommand();
		command.execute(sqlSession, model);
		return "reservation/reservationPage";
